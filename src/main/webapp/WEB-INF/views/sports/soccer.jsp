...
<meta charset="UTF-8">
<title>야구 게시판</title>
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/resources/css/soccer.css">
</head>
<body>
	<script>
	...
	<div id="background">
		...
		<div id="midtap">
			...
			<div id="middletap">
				...
				<div id="boardtitle">축구 게시판</div>
				<div id="category">
					<a href="http://localhost:8080/board/sports/soccer" class="category1">전체</a>
					<a href="http://localhost:8080/board/sports/soccer?minorCategory=epl" class="category2">EPL</a>
					<a href="http://localhost:8080/board/sports/soccer?minorCategory=laliga" class="category3">LALIGA</a>
					<a href="http://localhost:8080/board/sports/soccer?minorCategory=seriea" class="category4">SERIEA</a>
					<a href="http://localhost:8080/board/sports/soccer?minorCategory=bundes" class="category5">BUNDES</a>
				</div>
							...
							<tbody>
								<c:forEach items="${pagingData.boardDtoList}" var="boardDto">
									<tr>
										...
										<td>${boardDto.posts_minor_category}</td>
										<td><c:choose>
												<c:when
											...
											</c:choose> <a href="${readLink}">${boardDto.posts_title}</a>
										</td>
