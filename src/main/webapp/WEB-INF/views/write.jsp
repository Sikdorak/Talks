    ...
    <div id="background">
        ...
        <div id="midtap">
            <div id="lefttap">
                ...
                <form action="/board/create" method="post" id="write">
					<input type="text" name="posts_title" placeholder="제목" required maxlength="40" style="width: 600px; height: 30px; margin: 10px;"><br><br>
                    <textarea name="posts_content" placeholder="내용" required maxlength="300" style="width: 1000px; height: 600px; margin-left: 10px;"></textarea>
                    <input type="hidden" name="member_nickname" value="<%= session.getAttribute("member_nickname") %>">
